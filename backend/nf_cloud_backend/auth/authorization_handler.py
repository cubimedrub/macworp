...
def get_user_by_login_id(db: Session, login_id_query: str):
    ...
    # def register_new_user(db: Session, new_user: UserRegisterSchema, provider_type: str, provider: str) -> User:
    ...
    # def is_user_already_registered(db: Session, login_id: str) -> bool:
    #     db_user = Authorization.get_user_by_login_id(db, login_id)
    #     if db_user:
    #         return True
    #     else:
    #         return False
