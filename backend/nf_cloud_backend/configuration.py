...
# TODO: Create pydantic model and make in deserializable from YAML

SECRET_KEY = "development" # change for production, TODO: make it changeable via config or env var
...
login_providers:    # Will be completely overridden by local config
  openid:
    dev:
        ...
        discovery_url: http://localhost:9011/31a047c3-3353-fcd4-28e0-965a473a1ee8/.well-known/openid-configuration
