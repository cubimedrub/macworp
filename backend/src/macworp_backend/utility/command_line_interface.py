...
from macworp_backend.utility.rabbit_mq import RabbitMQ
...
class ComandLineInterface:
    ...
    def add_rabbitmq_cli_arguments(cls, subparsers: argparse._SubParsersAction):
        ...
        prepare_parser = local_subparsers.add_parser(
            "prepare", help="Creates RabbitMQ queues"
        )
    ...
    def add_configuration_cli_arguments(subparsers: argparse._SubParsersAction):
        ...
        create_config_parser = local_subparsers.add_parser(
            "create", help="Creates default config in given folder."
        )
        ...
        print_configuration_parser = local_subparsers.add_parser(
            "print", help="Prints default config in given folder."
        )
        print_configuration_parser.set_defaults(
            func=Configuration.print_default_config_by_cli
        )
