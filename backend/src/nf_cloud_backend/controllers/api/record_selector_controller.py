...
class RecordSelectorController:
    ...
    def select_records(workflow: str, argument: str):
        ...
        """
        workflow_argument: Dict[str, Any] = Configuration.values()["workflows"][workflow]["args"]["dynamic"][argument]
        ...
        return jsonify({
            "general": "unknown database protocol"
        })

    @staticmethod
    def select_sql(workflow_argument: Dict[str, Any], offset: Optional[int]) -> Tuple[Callable, Dict[str, str]]:
