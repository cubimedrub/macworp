...
from nf_cloud_backend.models.project import Project     # pylint: disable=unused-import
from nf_cloud_backend.models.user import User           # pylint: disable=unused-import
from nf_cloud_backend.models.workflow import Workflow   # pylint: disable=unused-import
...
class Database:
    ...
    def add_seed_subparser(cls, subparsers):
        ...
        subparsers : Any
            argparse's subparsers
        """
        parser = subparsers.add_parser("seed", help="Add some test data to the database (only for development)")
        parser.add_argument("--drop", required=False, default=False, action="store_true", help="If set, all data will be dropped before seeding.")
