...
class Project(SQLModel, table=True):
    ...
    def get_cached_workflow_parameters(self, workflow_id: int) -> dict:
        ...
        workflow_parameters_file = secure_joinpath(
            self.get_history_directory(), f"{workflow_id}.json"
        )
        ...
        try:
            ...
            try:
                ...
                raise ProjectSchedulingError(
                    "Failed to schedule project while publishing to QM"
                ) from e
    ...
    def save_workflow_params_cache(
        self, workflow, workflow_parameters: List[Dict[str, Any]]
    ):
        """
