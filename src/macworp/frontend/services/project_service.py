...
class ProjectService:
    ...
    async def get_project_ids(self) -> list[int]:
        ...
        async with httpx.AsyncClient(
            ...
            response = await client.get(
                f"{self.config.frontend.backend_url}/api/project/", headers=headers
            )
    ...
    async def get_project_descriptions(self, project_id: int) -> list[dict[str, str]]:
        ...
        async with httpx.AsyncClient(
            ...
            response = await client.get(
                f"{self.config.frontend.backend_url}/api/project/{project_id}",
                headers=headers,
            )
            if response.status_code == 200:
                return response.json()
    ...
    async def load_count(self):
        ...
        async with httpx.AsyncClient(
            ...
            response = await client.get(
                f"{self.config.frontend.backend_url}/api/project/count", headers=headers
            )
            if response.status_code == 200:
    ...
    async def load_projects(self, page: int) -> dict:
        ...
        async with httpx.AsyncClient(
            ...
            response = await client.get(
                f"{self.config.frontend.backend_url}/api/project/?offset={offset}&limit={self.PROJECTS_PER_PAGE}",
                headers=headers,
            )
            if response.status_code == 200:
                self.projects = response.json()
    ...
    async def get_project_root_path(self, project_id):
        ...
        async with httpx.AsyncClient(
            ...
            response = await client.get(
                f"{self.config.frontend.backend_url}/api/project/{project_id}/files?dir=/",  # Root-Verzeichnis
                headers=headers,
            )
    ...
    async def delete_project_path(self, project_id, project_path):
        ...
        async with httpx.AsyncClient(
            ...
            response = await client.post(
                f"{self.config.frontend.backend_url}/api/project/{project_id}/delete-path",
                headers=headers,
                json=path_payload,
            )
            if response.status_code == 200:
    ...
    async def delete_project(self, project_id):
        ...
        async with httpx.AsyncClient(
            ...
            response = await client.delete(
                f"{self.config.frontend.backend_url}/api/project/{project_id}/delete",
                headers=headers,
            )
            if response.status_code == 200:
                self.projects = response.json()
    ...
    async def update_project(self, project, project_id):
        ...
        async with httpx.AsyncClient(
            ...
            response = await client.post(
                f"{self.config.frontend.backend_url}/api/project/{project_id}/edit",
                headers=headers,
                json=cleaned_data,
            )
            if response.status_code == 200:
    ...
    async def get_file_path(self, project_id):
        ...
        async with httpx.AsyncClient(
            ...
            response = await client.get(
                f"{self.config.frontend.backend_url}/api/project/{project_id}/files",
                headers=headers,
            )
    ...
    async def create_project(self, project):
        ...
        async with httpx.AsyncClient(
            ...
            response = await client.post(
                f"{self.config.frontend.backend_url}/api/project/new",
                headers=headers,
                json=project,
            )
    ...
    async def change_user(self, new_owner: int, project, project_id) -> bool:
        ...
        async with httpx.AsyncClient(
            ...
            response = await client.post(
                f"{self.config.frontend.backend_url}/api/project/{project_id}/transfer_ownership",
                headers=headers,
    ...
    async def add_share_project(
        ...
        async with httpx.AsyncClient(
            ...
            response = await client.post(
                f"{self.config.frontend.backend_url}/api/project/{project_id}/share/add",
                headers=headers,
