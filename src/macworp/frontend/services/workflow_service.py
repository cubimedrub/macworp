...
class WorkflowService:
    ...
    async def load_workflows(
        ...
        async with httpx.AsyncClient(
            ...
            response = await client.get(
                f"{self.config.frontend.backend_url}/api/workflow/",
                headers=headers,
                params=params,
            )
    ...
    async def get_workflow(self, workflow: Dict[str, Any]) -> Dict[str, Any]:
        ...
        async with httpx.AsyncClient(
            ...
            response = await client.get(
                f"{self.config.frontend.backend_url}/api/workflow/{workflow['id']}",
                headers=headers,
            )
            if response.status_code == 200:
    ...
    async def delete_workflow(self, workflow: Dict[str, Any]) -> bool:
        ...
        async with httpx.AsyncClient(
            ...
            response = await client.delete(
                f"{self.config.frontend.backend_url}/api/workflow/{workflow['id']}/delete",
                headers=headers,
            )
            if response.status_code == 200:
                return True
    ...
    async def start_workflow(
        ...
        async with httpx.AsyncClient(
            ...
            response = await client.post(
                f"{self.config.frontend.backend_url}/api/project/{project_id}/schedule/{workflow['id']}",
                headers=headers,
    ...
    async def edit_workflow(
        self, workflow: Dict[str, Any], user_parameter_values: Dict[str, Any]
    ) -> bool:
        """
        ...
        async with httpx.AsyncClient(
            ...
            response = await client.post(
                f"{self.config.frontend.backend_url}/api/workflow/{workflow['id']}/edit",
                headers=headers,
                json=user_parameter_values,
            )
            if response.status_code == 200:
    ...
    async def save_workflow(self, workflow_data: Dict[str, Any]) -> bool:
        ...
        async with httpx.AsyncClient(
            ...
            response = await client.post(
                f"{self.config.frontend.backend_url}/api/workflow/new",
                headers=headers,
                json=payload,
            )
    ...
    async def publish_workflow(self, workflow):
        ...
        async with httpx.AsyncClient(
            ...
            response = await client.post(
                f"{self.config.frontend.backend_url}/api/workflow/{workflow['id']}/publish",
                headers=headers,
                json=workflow,
            )
        if response.status_code == 201:
